...
num_classes = 4
num_point_clouds_per_class = 150
...
for i in range(num_classes):
    for j in range(num_point_clouds_per_class):
        pc = torch.randn(10 * (i+1), input_dim)  # a point cloud with varying number of points based on class
...
model = PointBert(input_dim=input_dim, hidden_dim=hidden_dim, num_layers=num_layers, num_classes=num_classes)
